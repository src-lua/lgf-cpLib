 ...
 *   - Sem custos negativos, prefira Dijkstra+potenciais: O(E log V)/aug.
 *   - O custo retornado é o custo mínimo para enviar o fluxo máximo.
 */
...
struct MCMF {
    ...
    pair<Cap, Cost> flow(int s, int t,
                         Cap max_flow = numeric_limits<Cap>::max()) {
        Cap total_flow = 0;
        Cost total_cost = 0;
