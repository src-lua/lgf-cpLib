 ...
 * Hash polinomial: build O(N), comparação O(1).
 * Complexidade: O(N) build, O(1) query.
 * Memória: O(N)
 *
 * SingleHash: um par (MOD, BASE), com baixo risco de colisão.
...
struct SingleHash {
  ...
  static ll mul(ll a, ll b) { return (__uint128_t)a * b % MOD; }
...
const ll SingleHash::BASE = []() {
  ...
  return uniform_int_distribution<ll>(1e9,
                                      SingleHash::MOD - 1)(rng);
}();
...
struct DoubleHash {
  ...
  static ll mul1(ll a, ll b) {
    return (__uint128_t)a * b % MOD1;
  }
  static ll add1(ll a, ll b) {
    a += b;
    return a >= MOD1 ? a - MOD1 : a;
  }
  static ll mul2(ll a, ll b) { return (__int128)a * b % MOD2; }
  static ll add2(ll a, ll b) {
    a += b;
  ...
  pair<ll, ll> get(int l, int r) const {
    ...
    ll b = add2(h2[r + 1], MOD2 - mul2(h2[l], pw2[r - l + 1]));
    return {a, b};
  }
};
